{pkgs, ...}: {
  ...
  users.users.dan = {
    isNormalUser = true;
    description = "dan";
    extraGroups = ["networkmanager" "wheel" "adbusers" "wireshark" "docker" "libvirtd" "kvm" "qemu-libvirtd" "ydotool"];
    openssh.authorizedKeys.keys = [
      ...
      "ssh-rsa  surfacewindowsterminal"
