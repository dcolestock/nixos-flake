  ...
  flake.modules.homeManager.plasma = {...}: {
    dconf.settings = {
      "org/gnome/shell" = {
        ...
        favorite-apps = ["google-chrome.desktop" "discord.desktop" "com.mitchellh.ghostty.desktop" "steam.desktop" "org.gnome.Nautilus.desktop" "org.keepassxc.KeePassXC.desktop" "obsidian.desktop"];
      };
